                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.governorates.index') }}" wire:navigate>@lang('governorates.governorates')</a></li>
                            ...
                            <form method="post" action="{{ route('admin.governorates.update', $governorate->id) }}" class="ajax-form">
                                ...
                                <div class="row">
                                    ...
                                    @foreach (config('translatable.locales') as $locale)
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>@lang('governorates.governorate') (@lang('languages.' . $locale))<span class="text-danger">*</span></label>
                                                <input type="text" name="{{ $locale }}[name]" data-error-name="{{ $locale }}.name"
                                                       {{ $loop->first ? 'autofocus' : ''}}
                                                       class="form-control"
                                                       value="{{ old('name', $governorate->translate($locale)?->name) }}"
                                                       required
                                                >
                                            </div>
                                        </div>
