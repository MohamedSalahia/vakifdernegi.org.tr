                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if (auth()->user()->hasPermission('create_governorates'))
                                        <a href="{{ route('admin.governorates.create') }}" wire:navigate class="btn btn-primary"><i data-feather="plus"></i> @lang('site.create')</a>
                                    @endif

                                    @if (auth()->user()->hasPermission('delete_governorates'))
                                        <form method="post" action="{{ route('admin.governorates.bulk_delete') }}" style="display: inline-block;">
                                            @csrf
                                            @method('delete')
